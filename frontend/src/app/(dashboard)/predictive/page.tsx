  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div>
          <h1 className="text-4xl font-bold text-foreground">Predictive Analytics</h1>
      ...
      {isLoading ? (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold text-foreground">Portfolio Risk Overview</h3>
              ...
              <div className="flex gap-4 mt-2">
                {[{ color: "bg-red-400", label: "Cost" }, { color: "bg-orange-400", label: "Delay" }, { color: "bg-blue-400", label: "Safety" }].map(l => (
                  <div key={l.label} className="flex items-center gap-1.5"><div className={`w-2 h-2 rounded-full ${l.color}`} /><span className="text-xs text-muted-foreground">{l.label}</span></div>
                ))}
              </div>
            </motion.div>
          )}
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-border/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-foreground text-sm">AI Analytics Summary</p>
                  <p className="text-xs text-muted-foreground">Verbose technical + plain-language report</p>
                </div>
            ...
            <div className="px-6 pb-6 space-y-5 text-sm leading-relaxed">
                    ...
                    <div className="pt-5">
                      ...
                      <p className="text-muted-foreground">
                        This Predictive Analytics Report for <strong className="text-foreground">{projectName}</strong> is
                        computed live from this {isPortfolio ? "portfolio's" : "project's"} own{" "}
                        <strong className="text-foreground">Supabase</strong> records — schedule task delays,
                        ...
                        with a peak risk score of <strong className="text-foreground">{maxRisk.toFixed(0)}%</strong>.
                    ...
                    <div className="p-4 rounded-xl border border-border bg-secondary/20">
                      ...
                      <p className="text-muted-foreground">
                        A <strong className="text-foreground">rule-based risk score</strong> (not a trained model) returned a
                        probability of <strong className="text-foreground">{predictions.cost?.probability}%</strong> for
                        ...
                        {" "}This figure was derived from <strong className="text-foreground">open RFI count</strong>{" "}
                        (change-order proxy), <strong className="text-foreground">active workforce size</strong>,
                    ...
                    <div className="p-4 rounded-xl border border-border bg-secondary/20">
                      ...
                      <p className="text-muted-foreground">
                        <strong className="text-foreground">{predictions.delay?.probability}%</strong> of this{" "}
                        {isPortfolio ? "portfolio's" : "project's"} tracked tasks are currently delayed ({predictions.delay?.risk_level} risk),
                        averaging <strong className="text-foreground">{(predictions.delay as any)?.avgDelayDays || 0} days</strong> of
                        ...
                        <strong className="text-foreground">critical path compression</strong>.
                        {predictions.delay?.will_be_delayed
                          ? <> A delay outcome is predicted. Recommended interventions include{" "}
                            <strong className="text-foreground">resource augmentation</strong> on critical-path activities,{" "}
                            <strong className="text-foreground">fast-tracking</strong> parallel work streams,
                          ...
                          : <> Schedule variance remains within acceptable tolerances. Maintain current resource allocation
                            and task sequencing. Monitor the <strong className="text-foreground">critical path buffer</strong> weekly.</>
                        }
                      </p>
                    </div>
                    ...
                    <div className="p-4 rounded-xl border border-border bg-secondary/20">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        <strong className="text-foreground">recorded incident count and severity</strong>.
                        ...
                        {predictions.safety?.severe_risk
                          ? <> A <strong className="text-red-400">HIGH severity flag</strong> has been triggered.
                            ...
                            <strong className="text-foreground">toolbox talks</strong>, enhanced PPE enforcement,
                    ...
                    <div className="p-4 rounded-xl border border-border bg-secondary/20">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        <strong className="text-foreground">{predictions.meta?.equipment || 0} tracked units</strong>.
                        {" "}Equipment failures in construction projects cascade directly to{" "}
                        <strong className="text-foreground">schedule delays</strong> (mean 3.2-day impact per failure event)
                        ...
                        {predictions.equipment?.will_fail
                          ...
                          : <> Equipment fleet is operating within healthy parameters.
                            ...
                            Flag any unit falling below <strong className="text-foreground">70% health</strong> for early intervention.</>
                        }
                      </p>
                    </div>
                    ...
                    <div className="p-4 rounded-xl border border-border bg-secondary/20">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        <strong className="text-foreground">{predictions.meta?.workforce || 0} tracked workers</strong>.
                        {" "}High turnover in construction projects incurs a hidden cost of{" "}
                        <strong className="text-foreground">15–30% of annual salary per departure</strong> in onboarding
                        ...
                        {predictions.turnover?.will_leave
                          ? <> Retention risk is elevated. Review{" "}
                            <strong className="text-foreground">compensation benchmarks</strong> against local market rates,
                    ...
                    <div className="p-4 rounded-xl border border-blue-500/20 bg-blue-500/5">
                      ...
                      <p className="text-muted-foreground">
                        <strong className="text-foreground">Cost Overrun</strong> is a rule-based risk score (not a trained
                        model) computed from this {isPortfolio ? "portfolio's" : "project's"} real RFI, workforce, and
                        material-price data. <strong className="text-foreground">Delay, Safety, Equipment, and Turnover</strong> risk
        ...
        <div className="text-center py-20">
          ...
          <p className="text-sm text-muted-foreground mb-6">Select a project (or All Projects) and run ML predictions</p>
